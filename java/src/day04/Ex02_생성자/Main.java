...
public class Main {
	...
	public static void main(String[] args) {
		...
		Student student3 = new Student("배은주", 23, "교육학", "122323");
		...
		System.out.println("학생3 - 중간고사 점수 :" + student3.getAverage(100, 90, 70));

		int scores[] = { 100, 20, 40, 60 };
		System.out.println("학생3(배열) - 중간고사 점수 :" + student3.getAverage(scores));
